...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'todos', name: 'Todos', component: () => import('@/views/Todos.vue'), meta: { title: '待办事项', icon: 'BellFilled' } },
      { path: 'notifications', name: 'Notifications', component: () => import('@/views/Notifications.vue'), meta: { title: 'お知らせ', icon: 'Bell' } },
